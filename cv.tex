...
\begin{award}
  ...
  \collaborators{Össur, ehf. and Kristinn R. Þórisson, Reykjavík University}
  \startdate{May, 2014}
\end{award}
\begin{award}
  ...
  \duration{3 years}
  \amount{€75,000}
  \collaborators{Kristinn Þórisson, Reykjavík University; Yngví Björnsson,
...
\begin{publications}
  ...
  \begin{conferencepapers}
    ...
    \begin{paper}
      ...
      \author{Jordi Bieger, Kristinn R. Þórisson, and \textbf{Deon Garrett}}
